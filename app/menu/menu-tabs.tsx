...
/* ─── Main Page ─────────────────────────────────────────────── */
/**
 * The two slots are rendered on the server by app/menu/page.tsx and passed
 * in as children, so the product text ships in the HTML for crawlers and AI
  ...
  return (
    <>
      ...
      <div className="min-h-screen pt-16" style={{
                ...
                >
                  ...
                  >
                    <Image
                      ...
                      alt={`Product on display at the INNO100 flagship store in Shenzhen (${idx + 1} of ${imageFiles.length})`}
                      fill
        ...
        {/* ── Full Catalogue (server-rendered) ── */}
